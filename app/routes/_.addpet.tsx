...
export default function AddPetPage() {
  ...
  useEffect(() => {
    ...
    console.log(isValid);
  }, [name, type, breed, color, gender, ageYear, ageMonth, weight, spayed, detail, selectedGender, selectedType, selectedSpayed, image]);
      ...
      <div className="flex flex-row items-start justify-center space-x-10 p-20 w-[60%]">
        ...
        <div className="flex flex-col justify-center w-full items-start space-y-2">
          ...
          <CustomTextBox
            ...
            state={setDetail}
          />
          <CustomButton text="Add Pet For Adoption" destination="/pets" color="bg-primary-orange" disabled={!isFormValid} click={() => {setFetching(true);}}/>
        </div>
      </div>
    </div>
  );
